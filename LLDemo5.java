			...
			public static void main(String []args)
				{
					...
					DLinkList.Node element;
					for(int i=1;i<=10;++i)
						{
							element=list.new Node(i,null,null); 	
							list.addToStart(element);
						}
					System.out.println("Size of list= "+list.size());
					System.out.println(list.toString());
					element=list.new Node(11,null,null);
					list.addToLast(element);
				//	list.addBefore(list.header,element);
					System.out.println(list.toString());
					element=list.new Node(0,null,null);
					list.addToStart(element);
					System.out.println(list.toString());
					System.out.println("Size= "+list.size());
					list.delete(list.getFirstNode());
					System.out.println(list.toString());
				}
